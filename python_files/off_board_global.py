...
# ROS loop rate
    ...
    pick_up_lat=13.0107253#float(input("Enter pickup latitude:"))
    pick_up_long=80.2358043#float(input("Enter pickup longitude:"))
    drop_lat=13.0121783#float(input("Enter drop latitude"))
    drop_long=80.2399671#float(input("Enter drop longitude"))
